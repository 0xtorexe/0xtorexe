```aura width=860 height=200
 ...
 <div style={{ display:'flex', flexDirection:'column', marginLeft:168, gap:8, zIndex: 10 }}>
   ...
   <div style={{ display:'flex', gap:8, marginTop:6 }}>
     {['VAPT', 'Development', 'R & D', 'Reverse Engineering'].map(function(tag) {
       return (
         <div key={tag} style={{
...
(function() {
  var categories = [
    { title: 'Pentesting', color: '#a78bfa', items: ['Android', 'VAPT', 'Network PT','Automotive PT'] },
    { title: 'Developemt', color: '#60a5fa', items: ['React', 'NodeJS', 'Python', 'Php', 'C', 'Java', 'Assembly'] },
    { title: 'R&D', color: '#38bdf8', items: ['Automotive','EW', 'UAV', 'ELINT', 'COMINT', 'SIGINT', 'ELINT', 'UGVs', 'USV'] },
    { title: 'Topics', color: '#34d399', items: ['BlockChain', 'AIML', 'Quantum Computing', 'Psychology'] },
    { title: 'Focused Specialization', color: '#f43f5e', items: ['Automotive', 'Aerospace', 'Electronic Warfare'] },
  ];
...
```aura width=120 height=44 link="https://www.linkedin.com/in/hafizmuhammedah" inline align=center
<SocialMediaButton
...
```aura width=120 height=44 link="https://github.com/0xtorexe" inline align=center
<SocialMediaButton
